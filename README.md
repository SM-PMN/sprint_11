Реализация практической работы (Спринт 11), состоящей из следующих задач:
1. Развернуть с помощью Terraform три виртуальные машины — к ним должен быть доступ по SSH с помощью созданного ранее ключа. Для этого в блоке создания ВМ добавьте код:
